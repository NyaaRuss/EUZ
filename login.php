...
if(isset($_POST["submit"])){
    ...
    if($row){ // Check if a row is fetched
        ...
        if($password == $row["password"]){
            $_SESSION["loggedin"] = true; // Corrected session variable
            $_SESSION["id"] = $row["id"];
...
<body>
    ...
    <form class="" actions="" method="post" autocomplete="off">
        ...
        <h3>EUZ LOGIN PORTAL</h3>
       
        <label for="usernameemail">Username or Email</label>
        <input type="text" placeholder="Enter email" id="usernameemail" name="usernameemail" required value="">
        ...
        <a href="signup.php" >Create a account</a><br>
        <p>Forgot your password? <a href="passwordreset.php" style="color: red;">Reset it here</a></p>
