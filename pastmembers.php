...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
  ...
  <div class="jumbotron">
  <h1 style="color:#144a0b; text-align: center; font-size: 50px; font-weight: bolder; font-family: helvetica; text-shadow: 6px 6px 6px #dcf4da;">Past Members List</h1><br>
    ...
    <div class="container my-4">
        ...
        <?php
        include('connect.php');
        $sqlSelect = "SELECT * FROM past_members";
        ...
        while($data = mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td>
                    <a href="pastview.php?id=<?php echo $data['id']; ?>" class="btn btn-outline-success my-2 my-sm-0"><i class="fas fa-eye"></i></a>
                    <a href="confirmrestore.php?id=<?php echo $data['id']; ?>" class="btn btn-outline-secondary"><i class="fas fa-undo"></i></a>
