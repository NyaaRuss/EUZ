...
<link href="css/bootstrap.min.css" rel="stylesheet">
  ...
  <h1 style="color:#144a0b; text-align: center; font-size: 50px; font-weight: bolder; font-family: helvetica; text-shadow: 6px 6px 6px #dcf4da;">Past Member Record</h1>
    <div class="container my-4">
        <header class="d-flex justify-content-between my-4">
            <h2 style="color:green;"></h2>
            <div>
            <a href="pastmembers.php" class="btn btn-outline-primary">Back</a>
            </div>
        </header>
        <div class="member-details p-5 my-4">
            <?php
                ...
                $id = $_GET['id'];
                if ($id) {
                    $sql = "SELECT *, YEAR(DOB) AS year FROM past_members WHERE id = $id";
